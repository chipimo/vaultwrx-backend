...
interface UrnDeliverySectionProps {
  typeId: string;
  form: UseFormReturn<any>;
}

export const UrnDeliverySection = ({ typeId, form }: UrnDeliverySectionProps) => {
  ...
  return (
    <Card className='rounded-none shadow-none'>
      <CardContent className='space-y-4 px-4 py-3'>
        <div className='text-sm font-semibold text-foreground'>Delivery Location</div>
            ...
            >
              <div className='flex items-center gap-2'>
                ...
                <span className='truncate text-muted-foreground'>
                  {selectedLocation ? selectedLocation.name : 'Location name or address'}
                </span>
              </div>
            </Button>
          </PopoverTrigger>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='flex items-center gap-2 border-b border-input pb-1'>
            <span className='text-sm text-muted-foreground whitespace-nowrap'>Delivery Date</span>
          ...
          {/* Delivery Time Field */}
          <div className='flex items-center gap-2 border-b border-input pb-1'>
            <span className='text-sm text-muted-foreground whitespace-nowrap'>Delivery Time</span>
            <div className='relative flex-1'>
              <input
                type='time'
                className='w-full bg-transparent text-sm text-foreground outline-none [&::-webkit-calendar-picker-indicator]:opacity-0'

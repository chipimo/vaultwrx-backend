...
export default function VaultFormSection({
  ...
  return (
    <div className='border p-3 px-5'>
      <h4 className='text-lg font-semibold text-gray-900'>Choose A Vault</h4>
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              role='combobox'
              aria-expanded={open}
              className='h-10 w-full justify-between border-none font-normal'
      ...
      {selectedVault && (
        <div className='mt-2 flex justify-between gap-4'>
          <div className='flex'>
            <div className='flex h-48 w-48 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gray-100'>
              {selectedVault.photo_url ? (
                ...
                <span className='text-xs text-gray-400'>Vault Image</span>
              )}
            </div>

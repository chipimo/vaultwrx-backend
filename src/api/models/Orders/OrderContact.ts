...
export class OrderContact extends EntityBase {
  ...
  @ManyToOne(() => Order, (order) => order.contacts, { onDelete: 'CASCADE', nullable: true })
  ...
  @ManyToOne(() => OrderHistory, (orderHistory) => orderHistory.contacts, { onDelete: 'CASCADE', nullable: true })
